...
export type Pagina = 'visao-geral' | 'evolucao' | 'anatomia' | 'imagens' | 'imprimir' | 'documentos'
export interface Rota { pagina: Pagina; params: URLSearchParams }

const PAGINAS: Pagina[] = ['visao-geral', 'evolucao', 'anatomia', 'imagens', 'imprimir', 'documentos']
